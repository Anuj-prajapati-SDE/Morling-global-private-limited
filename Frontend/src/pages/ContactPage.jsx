      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            maxWidth: '800px',
            margin: '0 auto',
          }}>We'd love to hear from you. Fill out the form below and we'll get back to you as soon as possible.</p>
        </div>
          ...
          <div style={{
            ...
            <div style={{marginTop: '25px'}}>
              <div style={{display: 'flex', marginBottom: '15px'}}>
                <span style={{color: '#2867c3', marginRight: '15px', fontSize: '18px'}}>📍</span>
                <p style={{color: '#555', margin: 0}}>
                  SmartBrains Engineers and Technologist Pvt. Ltd., Sector 62, Noida
                </p>
              </div>
              <div style={{display: 'flex', marginBottom: '15px'}}>
                <span style={{color: '#2867c3', marginRight: '15px', fontSize: '18px'}}>📞</span>
                <p style={{color: '#555', margin: 0}}>+91 123-456-7890</p>
              </div>
              <div style={{display: 'flex', marginBottom: '15px'}}>
                <span style={{color: '#2867c3', marginRight: '15px', fontSize: '18px'}}>✉️</span>
